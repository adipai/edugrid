...
const FacultyContentAddActivity: React.FC = () => {
  ...
  const handleAddClick = async () => {
    if (activity_id) {
      ...
      try {
        ...
        navigate(
          `/faculty/activity-add-question?tb_id=${tb_id}&chap_id=${chap_id}&sec_id=${sec_id}&block_id=${block_id}&activity_id=${text}`
        );
      } catch (error) {
...
export default FacultyContentAddActivity;
