...
const FacultyAddNewContentBlock: React.FC = () => {
  ...
  const handleCreateBlock = async (action: string) => {
    try {
      ...
      if (action === "text") {
        navigate(
          `/faculty/content-add-text?tb_id=${tb_id}&chap_id=${chap_id}&sec_id=${sec_id}&block_id=${blockId}`
        );
      } else if (action === "pic") {
        navigate(
          `/faculty/content-add-pic?tb_id=${tb_id}&chap_id=${chap_id}&sec_id=${sec_id}&block_id=${blockId}`
        );
      } else if (action === "activity") {
        navigate(
          `/faculty/content-add-activity?tb_id=${tb_id}&chap_id=${chap_id}&sec_id=${sec_id}&block_id=${blockId}`
        );
      }
...
export default FacultyAddNewContentBlock;
